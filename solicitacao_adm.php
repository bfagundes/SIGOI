						...
						<div class="panel-body" style="height: 500px;">
							<div class="form-group">
								<div class="form-group">
									...
									<input type="text" placeholder="Nome" name="" id="" value="" class="form-control">
								</div>
								<div class="btn-group" role="group">
									<div class="form-group">
										<label for="nome-setor">Setor*</label>
										<div id="setor"><input type="text" class="typeahead form-control" placeholder="Setor" name="" id="" value=""></div>
									</div>
								</div>
								<div class="btn-group" role="group">
									<div class="form-group">
										<label for="nome-setor">Função*</label>
										<div id="funcao"><input type="text" class="typeahead form-control" placeholder="Função" name="" id="" value=""></div>
									</div>
								</div>
								<div class="form-group">
